...
export const T = {
  ...
  copyError:     { ar: "فشل النسخ",           en: "Copy failed" },
  copyName:      { ar: "نسخ الاسم",           en: "Copy Name" },
  copyEmail:     { ar: "نسخ البريد الإلكتروني", en: "Copy Email" },
  copyPhone:     { ar: "نسخ الهاتف",          en: "Copy Phone" },
  copyCompany:   { ar: "نسخ اسم الشركة",      en: "Copy Company" },
  copyCity:      { ar: "نسخ المدينة",         en: "Copy City" },
  sendEmail:     { ar: "إرسال بريد إلكتروني", en: "Send Email" },
  openWhatsapp:  { ar: "فتح واتساب",          en: "Open WhatsApp" },
