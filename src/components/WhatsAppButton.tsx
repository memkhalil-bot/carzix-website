...
export default function WhatsAppButton() {
  return (
    ...
    >
      ...
      <span className="relative w-12 h-12 rounded-full bg-[#25D366] flex items-center justify-center shadow-[0_4px_20px_rgba(37,211,102,0.38)] group-hover:shadow-[0_6px_28px_rgba(37,211,102,0.55)] group-hover:scale-110 group-hover:-translate-y-0.5 transition-all duration-300">
